...
const navigationBaseClass = [
  "group pointer-events-auto fixed top-[7.19vh] z-50 inline-flex w-max items-center justify-center",
...
export function SiteHeader() {
  return (
    <header className="pointer-events-none fixed inset-0 z-50 h-0" aria-label="Navegação principal">
      <a
        className="pointer-events-auto fixed left-[3.35vw] top-[4.11vh] block w-[clamp(72px,5.8vw,108px)] no-underline transition-opacity duration-300 before:absolute before:-inset-3 before:content-[''] hover:opacity-70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/50 max-md:left-5 max-md:top-[1.35rem] max-md:w-[78px]"
        href="#top"
